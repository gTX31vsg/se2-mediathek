        ...
        implements VerleihService
{
    ...
    public boolean istVormerkenMoeglich(Kunde kunde, List<Medium> medien)
    {
        ...
        for (Medium medium : medien) {
            ...
            if (istVorgemerkt(medium)) {
                if (!getVormerkkarteFuer(medium).vormerkenMoeglich(kunde)) {
                    return false;
                }
            }
        }
    ...
    @Override
    public void removeVormerkung(Medium medium)
    {
            ...
            throws ProtokollierException
    {
        ...
        for (Medium medium : medien)
        {
            if (istVorgemerkt(medium)) {
                ...
                if (vormerkkarte.anzahlVormerker() == 1) {
                    removeVormerkung(medium);
                } else {
    ...
    public void merkeVor(Kunde kunde, Medium medium)
    {
        ...
        if (!istVorgemerkt(medium)) {
            ...
            vormerkkarte.addKunde(kunde);
        } else {
            vormerkkarte = getVormerkkarteFuer(medium);
            if (vormerkkarte.vormerkenMoeglich(kunde)) {
                vormerkkarte.addKunde(kunde);
            }
        }
