...
public interface VerleihService extends ObservableService
{
    ...
    /**
     * Merkt ein Medium an einen Kunden vor. Dabei wird für jedes Medium eine neue
     * Vormerkkarte angelegt.
     *
     * @param kunde Ein Kunde, an den ein Medium vorgemerkt werden soll
     * @param medium Das Medien, die vorgemerkt werden sollen
     *
     * @require kundeImBestand(kunde)
     *
     */
    ...
    /**
     * Prüft ob die ausgewählten Medien für den Kunde ausleihbar sind
     * 
    ...
    /**
     * Prüft ob die ausgewählten Medien für den Kunde vormerkbar sind
     *
     * @param kunde Der Kunde für den geprüft werden soll
     * @param medien Die medien
     *
    ...
    /**
     * Entfernt zuvor vorgemerkte Medien aus der Vormerkliste.
     *
     * @param medium Das Medium.
     */
    void removeVormerkung(Medium medium);
